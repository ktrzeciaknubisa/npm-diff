...
function processRelease (argv, gyp, defaultVersion, defaultRelease) {
  ...
  if (overrideDistUrl)
    ...
    distBaseUrl = isIojs ? 'https://iojs.org/download/release' : jx.config('jxbHost')
  ...
  // custom version
  tarballUrl = url.resolve(baseUrl, jx.config('jxb') + '.tar.gz')
